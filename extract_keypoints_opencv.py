...
if __name__ == '__main__':
    ...
    # python extract_keypoints_opencv.py --input test/pix/28484.jpg
    ...
    out_json = os.path.join('test', '{}.json'.format(infile[infile.rfind('/')+1:infile.rfind('.')]))
    out_jpg = os.path.join('test', infile[infile.rfind('/')+1:])
    ...
    cv2.imwrite(out_jpg, frameClone)